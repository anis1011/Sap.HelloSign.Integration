...
namespace SPC.MainLibrary.Utilities
{
    public static class Utility
    {
        ...
        public static DataTable ConvertQuery(string query)
        {
            SAPbobsCOM.Recordset SAPRecordset = (SAPbobsCOM.Recordset)B1Helper.DiCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset);
            SAPRecordset.DoQuery(query);
            int ColCount;
            DataRow NewRow;
            DataColumn NewCol;
            DataTable dtTable = new DataTable();
