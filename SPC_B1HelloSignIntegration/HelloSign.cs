using HelloSign;
using SPC_B1HelloSignIntegration.Helper;
using System;
using System.IO;

namespace SPC_B1HelloSignIntegration
{
    public class HelloSign
    {
        ...
        public HelloSign()
        {
            client = new Client(AppConfiguration.API_KEY);
            client.SetApiHost(AppConfiguration.API_HOST);
            //Test();
